...
var NimblePicker = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function NimblePicker(props) {
    ...
    _this.getEmojiIndex = _this.getEmojiIndex.bind(_assertThisInitialized(_this));
    _this.getEmojiElement = _this.getEmojiElement.bind(_assertThisInitialized(_this));
    _this.getEmojiToPreview = _this.getEmojiToPreview.bind(_assertThisInitialized(_this));
    _this.getEmojisInCategory = _this.getEmojisInCategory.bind(_assertThisInitialized(_this));
    ...
    _this.handleEmojiKeyDown = _this.handleEmojiKeyDown.bind(_assertThisInitialized(_this));
  ...
  _createClass(NimblePicker, [{
    ...
    value: function getEmojiToPreview(categoryIndex, emojiIndex) {
      ...
      var emoji = emojis[emojiIndex];
      var emojiToPreview = getSanitizedData(emoji, this.state.skin, this.props.set, this.props.data);
    ...
    value: function getEmojisInCategory(categoryIndex) {
      return categoryIndex === 1 ? frequently.get(this.props.perLine) : this.categories[categoryIndex].emojis;
    }
  }, {
    key: "getEmojiIndex",
