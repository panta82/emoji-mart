...
var Category = /*#__PURE__*/function (_React$Component) {
  ...
  function Category(props) {
    ...
    _this.setEmojiTableRef = _this.setEmojiTableRef.bind((0, _assertThisInitialized2["default"])(_this));
    return _this;
  }
  ...
  (0, _createClass2["default"])(Category, [{
    ...
    key: "setEmojiTableRef",
    value: function setEmojiTableRef(c) {
    ...
    value: function render() {
      ...
      var EmojiTable = function EmojiTable(_ref) {
        var emojis = _ref.emojis;
        var trs = [];

        var _loop = function _loop(i) {
          trs.push( /*#__PURE__*/_react["default"].createElement("tr", {
            role: "row",
            key: "emoji-row-".concat(i)
          }, emojis.slice(i, i + perLine).map(function (emoji, j) {
            return /*#__PURE__*/_react["default"].createElement("td", {
              ...
              onKeyDown: function onKeyDown(e, emoji) {
                emojiProps.onKeyDown(e, emoji, {
                  category: id,
                  row: Math.floor(i / perLine),
                  column: j
                }, _this3.emojiTableRef);
              }
            })));
          })));
        };

        for (var i = 0; i < emojis.length; i += perLine) {
          _loop(i);
        }
        ...
        return /*#__PURE__*/_react["default"].createElement("table", {
          ...
          role: "grid"
        }, /*#__PURE__*/_react["default"].createElement("tbody", null, trs));
      };
      ...
      }, label)), emojis && /*#__PURE__*/_react["default"].createElement(EmojiTable, {
        emojis: emojis
